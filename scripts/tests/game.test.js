...
describe ("game object contain correct keys", () => {
    ...
    test("choices values to match the id of the circles", () => {
...
describe("newGame works correctly", () => {
    ...
    test("should be one move/element in the computer's game array", () => {
...
describe("gameplay works correctly", () => {
    ...
    test("clicking during the computer's turn should do nothing", () => {
        showTurns();
        game.lastButton = "";
